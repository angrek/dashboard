...
mail william.rehfield@wellcare.com < 1
/home/wrehfiel/ENV/bin/python dashboard/aix_centrify.py
mail william.rehfield@wellcare.com < 2
python dashboard/aix_errpt.py
mail william.rehfield@wellcare.com < 3
python dashboard/aix_imperva.py
mail william.rehfield@wellcare.com < 4
python dashboard/aix_oslevel.py
mail william.rehfield@wellcare.com < 5
python dashboard/aix_ssl.py
mail william.rehfield@wellcare.com < 6
python dashboard/aix_storage.py
mail william.rehfield@wellcare.com < 7
python dashboard/aix_xcelys.py
mail william.rehfield@wellcare.com < 8
