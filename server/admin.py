...
class LinuxApplicationsAdmin(ImportExportActionModelAdmin):
    ...
    list_max_show_all = 500
    save_on_top = True
    list_display = ['name', 'active','exception', 'stack', 'os', 'os_level', 'zone', 'centrify', 'centrifyda', 'xcelys', 'bash', 'ssl', 'glibc', 'netbackup', 'syslog', 'rsyslog', 'iptables_on', 'rsyslog_r', 'samba', 'python']
    list_filter = ['active', 'exception', 'zone', 'stack', 'os', 'os_level', 'centrify', 'centrifyda', 'xcelys', 'bash', 'ssl', 'glibc', 'netbackup', 'syslog', 'rsyslog', 'rsyslog_r', 'samba', 'python', 'iptables_on']
    search_fields = ['name', 'os', 'os_level', 'centrify', 'xcelys', 'bash', 'ssl', 'glibc', 'netbackup']
    readonly_fields = ['created', 'modified']
    fields = ['name', 'active', 'exception', 'stack', 'decommissioned', 'modified', 'os', 'os_level', 'zone', 'centrify', 'centrifyda', 'xcelys', 'bash','ssl', 'glibc', 'java', 'netbackup', 'syslog', 'rsyslog', 'rsyslog_r', 'samba', 'python', 'iptables_on', 'application_paths']
    resource_class = LinuxServerResource
    class Media:
        js = ['/static/admin/js/list_filter_collapse.js']
    pass
